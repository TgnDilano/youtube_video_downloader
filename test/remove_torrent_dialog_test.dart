...
void main() {
  testWidgets('shows a warning and asks about the original file for file source',
      (tester) async {
    ...
    expect(find.text('Also delete the downloaded data from disk'), findsOneWidget);

    // tapping the original-file checkbox stays within the dialog; REMOVE dismisses it
    await tester.tap(find.text('Also delete the original ubuntu.torrent file'));
    await tester.pump();
    expect(find.text('Also delete the original ubuntu.torrent file'), findsOneWidget);
